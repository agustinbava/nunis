// Native-specific crypto using expo-crypto + tweetnacl
...
export function encryptForRecipient(
  plaintext: string, recipientPublicKey: Uint8Array, senderSecretKey: Uint8Array
): string {
...
export function decryptFromSender(
  ciphertext: string, senderPublicKey: Uint8Array, recipientSecretKey: Uint8Array
): string {
  const fullMessage = naclUtil.decodeBase64(ciphertext);
